...
int main() {
    auto poses_gt = loadPosesKittiFormat("/home/duc/Desktop/Photometric/data/data_odometry_poses/dataset/poses/05.txt");
    ...
    //double MeanRPE = 
    std::ofstream ofs("./eval_result/eval_t_r_error_init_05.txt");
    
    ComputeMeanRPE(init_poses_global,poses_gt,10,lengths,ofs);
    
    std::ofstream ofs1("./eval_result/eval_t_r_error_origin_05_r1.txt");
    
    ComputeMeanRPE(refined_poses_global_origin,poses_gt,10,lengths,ofs1);
    
    std::ofstream ofs2("./eval_result/eval_t_r_error_new_05_05_r2.txt");
