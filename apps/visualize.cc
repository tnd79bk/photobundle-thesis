...
int main(int argc, char** argv)
{
    ...
    auto refined_poses_global = loadPosesKittiFormat("/home/duc/Desktop/Photometric/photobundle-master/apps/refined_poses_new_00_0.3_r1.txt");
    ...
    std::ofstream ofs("xyz-new-00-0.3-r1.txt");
